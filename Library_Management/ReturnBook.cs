...
namespace Library_Management
{
    public partial class ReturnBook : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand comando = new SqlCommand("Select Name as [Student Name],[BOOK TITLE],br.Date as [Borrow Date],DATEADD(DAY, 7, [Date]) AS [Return Date]  from Book b inner join Borrower br on b.ISBN = br.ISBN", cnn);
